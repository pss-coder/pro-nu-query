  ...
  return (
    <Combobox className={clsx('', className)} as="div" value={selectedPerson} onChange={setSelectedPerson}>
      ...
      <div className="relative mt-2">
        ...
        <Combobox.Button 
        className= { props.isBtnHidden ? "absolute inset-y-0 right-0 flex items-center rounded-r-md px-2 focus:outline-none" : "absolute inset-y-0 right-10 flex items-center rounded-r-md px-2 focus:outline-none"}  
        >
