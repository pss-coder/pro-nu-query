...
export function getColumns() {
    const columns = [
        { id: 0, name: 'nucleic_acid_name', display:'Nucleic Acid Name' },
        { id: 1, name: 'type_nuc', display: 'Nucleic Acid Type'  },
        { id: 2, name: 'mutation_protein', display:'Mutation' },
        { id: 3, name: 'protein_name', display:'Protein Name' },
        { id: 3, name: 'protein_source', display:'Protein Source' },
        { id: 4, name: 'method', display:'Method' },
        { id: 5, name: 'journal', display:'Journal' },
    ]
    return columns;
}
